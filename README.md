...
[![Build
Status](https://travis-ci.org/reconhub/projections.svg?branch=master)](https://travis-ci.org/reconhub/projections)
[![Build
status](https://ci.appveyor.com/api/projects/status/265h2el4y9popan9/branch/master?svg=true)](https://ci.appveyor.com/project/thibautjombart/projections/branch/master)
...
follows a Poisson process determined by a daily infectiousness, computed
as:
...
i <- incidence(linelist, date_index = date_of_onset)
plot(i) # full outbreak
```

<img src="man/figures/README-onset-1.png" width="80%" style="display: block; margin: auto;" />

``` r
plot(i[1:160, ]) # first 160 days
```

<img src="man/figures/README-onset-2.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-si-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-predictions-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-predictions-2.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-plot_with_incidence-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-plots-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-other_si-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-pred_2-1.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-pred_2-2.png" width="80%" style="display: block; margin: auto;" />
...
i_hosp <- incidence(
  ...
  groups = hospital)
plot(i_hosp, fill = hospital)
```

<img src="man/figures/README-adding_forecasts-1.png" width="80%" style="display: block; margin: auto;" />

``` r


## derive predictions for each hospital
hospitals <- split(i_hosp, i_hosp$hospital)
hospitals <- lapply(hospitals, regroup)
...
names(pred_hosp) <- names(hospitals)
...
<img src="man/figures/README-adding_forecasts-2.png" width="80%" style="display: block; margin: auto;" />
...
<img src="man/figures/README-offset-1.png" width="80%" style="display: block; margin: auto;" />
